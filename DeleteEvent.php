...
?>
        ...
        $sql="DELETE from event where ename='$name'";
        echo $eid;
		...
		<div class="sidenav">
			...
			<nav class="navbar" style="height: 92px;">
					...
					<span class="navbar-text" style="padding-left:30px;">
						<a href="Logout.php" style="color: white; font-size: 20px; position:absolute;right: 70px;top: 27px;">Logout</a>
					</span>
			</nav>
			
		</div>
		
		 <div class="card" style="width:40rem;height: 11.7rem; position: absolute;left: 500px; top: 120px;border: none; ">
  <div class="card-body">
    <h1 style="text-align: center; position: absolute;top: 60px; left: 250px;">DELETE</h1>
...
<div class="card shadow-lg p-3 mb-5 bg-white rounded" style="width:50rem;height: 20rem; position: absolute;left: 420px; top: 280px; ">
  <div class="card-body">
    ...
    <form  method="post" class="form" style="height: 30rem;">
    	<h3 style="text-align:center;padding-bottom: 40px;">REMOVE EVENT </h3>

 
  <div class="form-group" style="margin-top: 20px";>
    <label for="ename"> Event Name</label>
    <input type="text" class="form-control" id="eid" placeholder="Enter Event Name" name="eventname" required>
  </div>
