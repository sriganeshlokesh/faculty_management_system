...
{   
    $sql = "INSERT INTO leavestatus (uname, lstartdate,lenddate,ltype)
    VALUES ('".$_POST["uname"]."','".$_POST["startdate"]."','".$_POST["enddate"]."','".$_POST["leavetype"]."')";
      
      
    if ($conn->query($sql) == TRUE) {
      
    echo '<script language="javascript">';
    echo 'alert("Application Sent Successfully")';      
    echo '</script>';
}
    else {
    echo '<script language="javascript">';    
    echo 'alert("Application Not Sent")';
    echo '</script>';
}
...
.lcard{
  ...
  <div class="card-body">
    <h1 style="text-align: center;padding-top: 55px;">LEAVE APPLICATION</h1>
    
   
  </div>
</div>
      <div class="card shadow-lg p-3 mb-5 bg-white rounded" style="width:50rem;height: 25rem; position: absolute;left: 320px; top: 600px; ">
  <div class="card-body">
    <div >
    <form method="post" class="form" style="height: 30rem;">
  <div class="form-group">
    <label for="username">Teacher Name</label>
    <input type="text" class="form-control" id="eventname" aria-describedby="userHelp" placeholder="Enter Teacher Name" name="uname" required>
  </div>
  ...
  <div class="row" style="margin-top: 20px";>
    <div class="col">
      ...
      <input type="text" class="form-control" placeholder="Enter Leave Type" name="leavetype" required>
    </div>
  <button type="submit" class="btn btn-primary btn-lg btn-dark" name="submit" style="position: absolute; left: 360px;top:320px;">Submit</button>
